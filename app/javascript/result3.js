function post() {
  const carbohydrates1Element = document.getElementById('nutrients3-1');
  const carbohydrates2Element = document.getElementById('nutrients3-2');
  const carbohydrates3Element = document.getElementById('nutrients3-3');
