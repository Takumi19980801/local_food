function post (){
  ...
  selectBox.addEventListener('change', function() {
    ...
    if (selectedId === '1') {
      ...
      document.getElementById('nutrients1-1').textContent = '51.9';
      document.getElementById('nutrients2-1').textContent = '3';
      document.getElementById('nutrients3-1').textContent = '0.3';
    } else if (selectedId === '3') {
      document.getElementById('nutrients1-1').textContent = '29.9';
      document.getElementById('nutrients2-1').textContent = '5.3';
      document.getElementById('nutrients3-1').textContent = '2.4';
      ...
      document.getElementById('nutrients1-1').textContent = '80.5';
      document.getElementById('nutrients2-1').textContent = '14.5';
