function post() {
  const selectBox = document.getElementById('meal_side_dish_count_id');
  const carbohydratesElement = document.getElementById('nutrients1-3');
  const proteinElement = document.getElementById('nutrients2-3');
  const lipidElement = document.getElementById('nutrients3-3');
